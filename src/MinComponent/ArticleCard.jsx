...
const ArticleCard = ({ ID }) => {
  return (
    <>
      <div>
        <div className="bg-white h-[220px] shadow-lg rounded-lg overflow-hidden text-right flex" style={{ direction: "rtl" }}>
          <img
            ...
            <div className="mt-4">
              ...
              <div className="flex items-center  justify-between">
                <div className="flex items-center gap-2">
                  <img className="w-10 h-10 object-cover object-center rounded-full" src={news.Article[ID].avatar} alt="avatar" />
